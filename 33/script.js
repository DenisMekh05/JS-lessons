...
//<div id="block1"></div>
document.querySelector('#block1').style.borderRadius = '10px'

2
//что делает обработчик событий?
//  создает событие при взаимодействи с элементом

3
//наложите обработчик события клик на 'button' который поменяет цвет текста в теге 'p' на красный
...
btn.addEventListener('mouseEnter', showMessage)
